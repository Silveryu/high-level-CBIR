...
int main(int argc, char **argv)
{
  ...
  double rms = cv::StereoCalibrate(object_points, ipts_1,ipts_2,intrinsic_matrix_1,distortion_coeffs_1,intrinsic_matrix_2,distortion_coeffs_2.image1.size(),R,T,I,L);
