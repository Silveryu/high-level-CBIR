...
def addToIndex(countsClass,file,classes):
    global index
    global imagesInf
    imageInf = [0] * len(classes)
...
def postprocess(file, outs):
    ...
    #index File
    print(countsClass)
    addToIndex(countsClass, file, classes)
    return countsClass
...
serializeObj(imagesInf,"imagesInf")
print(index)
print(imagesInf)